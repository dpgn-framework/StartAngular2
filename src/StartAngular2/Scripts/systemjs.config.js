(function (global) {
    ...
    var map = {
        ...
        '@angular': 'StartAngular2/node_modules/@angular', // angular2 packages
        'rxjs': 'StartAngular2/node_modules/rxjs' // Rxjs package
    };
    // packages tells the System loader which filename and/or extensions to look for by default (when none are specified)
    var packages = {
        'app': { main: '../StartAngular2/app/main.js', defaultExtension: 'js' },
