...
using StartAngular2.Data.Comments;
...
public class DbSeeder
{
    ...
    private void CreateItems()
    {
        ...
        EntityEntry<Item> e1 = DbContext.Items.Add(new Item()
        {
            UserId = authorId,
            Title = "Magarena",
            Description = "Single-player fantasy card game similar to agic: The Gathering",
...
Scrabble by adding a new whole third dimension.Other than playing left to right or top to bottom,
